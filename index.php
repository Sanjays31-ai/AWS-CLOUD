        ...
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/icn1.png" alt=""> </a>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    ...
                    <p class="lead">Easiest way to order your favourite food among these top 4 dishes</p>
                </div>
                <div class="row">
						<?php 					
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                ...
                                <h5>Contact</h5>
                           <p>S Sridhar  &nbsp; &nbsp; 21MIS0140
                           </p>
                           <p>S Pranav   &nbsp; &nbsp; 21MIS0148</p>
                           <p>A Srinath   &nbsp; &nbsp; 21MIS0153</p>
                                </div>
                    </div>
                </div>
